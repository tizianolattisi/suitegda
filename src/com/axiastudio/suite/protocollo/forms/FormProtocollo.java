...
public class FormProtocollo extends Form {
    ...
    private final String ALFRESCOURL="http://127.0.0.1:8080/share/page/dologin?username=pypapi&password=0i2kiwi&success=/share/page/site/protocollo/documentlibrary#filter=path%%7C/%s&page=1";
