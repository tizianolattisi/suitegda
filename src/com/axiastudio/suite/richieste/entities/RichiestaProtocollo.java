...
@SequenceGenerator(name="genrichiestaprotocollo", sequenceName="richieste.richiestaprotocollo_id_seq", initialValue=1, allocationSize=1)
public class RichiestaProtocollo implements Serializable, ITimeStamped {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="genrichiestaprotocollo")
    private Long id;
...
//            return this.richiesta.getId().toString() + " - " +  this.richiesta.getMittente().toString() + " - " +
//                    this.richiesta.getData() + " - " + this.richiesta.getDatascadenza() + " - " +  this.richiesta.getTesto();
        }
    }
   ...
   public String getRecordmodificatoda() {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RichiestaProtocollo)) {
            return false;
        }
        RichiestaProtocollo other = (RichiestaProtocollo) object;
        return !((this.id == null && other.id != null) || (this.id != null && !this.id.equals(other.id)));
    }

    @Override
    public String toString() {
        return "Richiesta n. " + getRichiesta().toString() + " - Protocollo " + getProtocollo().toString();
    }
}
